...
const BannerCard = () => {
  ...
  return (
    <div className={`bg-[url('/image/home/banner/banner1.jpg')] bg-cover bg-center bg-no-repeat`}>
        ...
        <div className='max-w-screen-md px-5 mx-auto pb-40 pt-60 text-white text-center'>
            ...
            <h1 className='text-3xl md:text-5xl font-semibold mx-auto my-5'>Explore Your Beutiful Place With us</h1>
